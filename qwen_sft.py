...
def main():
    ...
    if data_args.train_type != 'sft':   
        ...
        teacher = None
    seq2seq_model.generation_config.pad_token_id = tokenizer.pad_token_id
    ...
    def preprocess_for_inference(examples):
        ...
        qs = [prefix + q.lstrip() + tokenizer.eos_token for q in examples[question_column]]
        ...
        for step, batch in enumerate(active_dataloader):
            ...
            or step == len(train_dataloader):
                ...
                for step_e, batch in enumerate(eval_dataloader):
                    ...
                    gen_out = gen_out[:, batch["input_ids"].shape[1]:]
                    # print("5555555", gen_out)
                ...
                if accelerator.is_main_process:
                    print(f"[Eval] step={completed_steps}  {use_key}={score:.4f}", "best score: ", best_score)
                    ...
                    if "gsm8k" in data_args.train_file and score > 40:
                        save_this_one = True
                    else:
                        save_this_one = False
                    print("save_this_one", save_this_one)
                    if score > best_score or save_this_one:            # global best on this run
                        best_score = score
                        print("are you saving me?")
                        ...
                        if hasattr(model, "peft_config"):              # LoRA / QLoRA
                            ...
                            print("are you saving me here?")
                        tokenizer.save_pretrained(save_dir)
                        print("are you saving me everything here?")
