...
from utils.tokenizer_13a import Tokenizer13a
...
class Bleu(evaluate.Metric):
    ...
    def _compute(self, predictions, references, tokenizer=wordpunct_tokenize, max_order=4, smooth=False):
        ...
        chrf_score = corpus_chrf(predictions, [references]).score
        ter_score = corpus_ter(predictions, [references]).score
